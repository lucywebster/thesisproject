...
pkgdatadir = $(datadir)/pimeter
pkgincludedir = $(includedir)/pimeter
pkglibdir = $(libdir)/pimeter
pkglibexecdir = $(libexecdir)/pimeter
...
libpivumeter_la_LIBADD =
am__dirstamp = $(am__leading_dot)dirstamp
am_libpivumeter_la_OBJECTS = src/pivumeter.lo \
	src/devices/scroll-phat.lo src/devices/scroll-phat-hd.lo \
	src/devices/blinkt.lo src/devices/speaker-phat.lo \
	src/devices/phat-beat.lo
libpivumeter_la_OBJECTS = $(am_libpivumeter_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(libpivumeter_la_SOURCES)
DIST_SOURCES = $(libpivumeter_la_SOURCES)
...
ACLOCAL = ${SHELL} /home/rpi2/pivumeter/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/rpi2/pivumeter/missing autoconf
AUTOHEADER = ${SHELL} /home/rpi2/pivumeter/missing autoheader
AUTOMAKE = ${SHELL} /home/rpi2/pivumeter/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/rpi2/pivumeter/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 0.44
abs_builddir = /home/rpi2/pivumeter
abs_srcdir = /home/rpi2/pivumeter
abs_top_builddir = /home/rpi2/pivumeter
abs_top_srcdir = /home/rpi2/pivumeter
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/rpi2/pivumeter/install-sh
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/pivumeter.lo: src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
...
src/devices/scroll-phat.lo: src/devices/$(am__dirstamp) \
	src/devices/$(DEPDIR)/$(am__dirstamp)
src/devices/scroll-phat-hd.lo: src/devices/$(am__dirstamp) \
	src/devices/$(DEPDIR)/$(am__dirstamp)
src/devices/blinkt.lo: src/devices/$(am__dirstamp) \
	src/devices/$(DEPDIR)/$(am__dirstamp)
src/devices/speaker-phat.lo: src/devices/$(am__dirstamp) \
	src/devices/$(DEPDIR)/$(am__dirstamp)
src/devices/phat-beat.lo: src/devices/$(am__dirstamp) \
	src/devices/$(DEPDIR)/$(am__dirstamp)

libpivumeter.la: $(libpivumeter_la_OBJECTS) $(libpivumeter_la_DEPENDENCIES) $(EXTRA_libpivumeter_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK) -rpath $(libdir) $(libpivumeter_la_OBJECTS) $(libpivumeter_la_LIBADD) $(LIBS)
...
include src/$(DEPDIR)/pivumeter.Plo
include src/devices/$(DEPDIR)/blinkt.Plo
include src/devices/$(DEPDIR)/phat-beat.Plo
include src/devices/$(DEPDIR)/scroll-phat-hd.Plo
...
distclean: distclean-am
	...
	-rm -rf src/$(DEPDIR) src/devices/$(DEPDIR)
	-rm -f Makefile
